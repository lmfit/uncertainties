...
**WARNING**: the ``master`` branch and the Conda package version 3.1.3 do not seem to be in a working condition. It is currently advisable to use this package through `PyPI <https://pypi.org/project/uncertainties>`_ or `Conda <https://anaconda.org/conda-forge/uncertainties>`_ (package version 3.1.2 only).
